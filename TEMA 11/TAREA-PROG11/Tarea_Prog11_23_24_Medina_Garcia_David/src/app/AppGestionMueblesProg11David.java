 ...
 */
public class AppGestionMueblesProg11David extends javax.swing.JFrame {
    ...
    // PROG11 y clave 123 a la base de datos local XEPDB1
    ConexionBD con = abrirConexion();

    /**
     * Creates new form InicioArticulos
     */
    public AppGestionMueblesProg11David() {
        initComponents();
    ...
    private void btnBuscarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarVentaActionPerformed
        ...
        m = con.leerMueble(v.getIdMueble());
...
// TODO add your handling code here:
    ...
    private void btnModificarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarVentaActionPerformed
        ...
        if (idMuebleAnterior == idMuebleVenta) {
            ...
            v.setIdMueble(idMuebleVenta);
        }

        // Modificar la venta en la base de datos con los nuevos datos
        con.modificarVenta(idVenta, nombreCliente, unidadesVendidas, idMuebleVenta);
    ...
    private void btnEliminarVentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarVentaActionPerformed
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ...
            int idMuebleVenta = v.getIdMueble();
    ...
    private void llenarVenta() {
        ...
        v.setIdMueble(Integer.parseInt(txtIdMuebleVenta.getText()));
    }
    ...
    private void visualizarVenta() {
        ...
        txtIdMuebleVenta.setText(String.valueOf(v.getIdMueble()));
    }
    ...
    ConexionBD abrirConexion() {
        // Crea la conexión del usuario prog11 y clave 123 a la BBDD : XEPDP1
        ConexionBD conexion = new ConexionBD("oracle", "localhost", "XEPDB1", "PROG11", "123");
        return conexion;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppGestionMueblesProg11David.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> {
            new AppGestionMueblesProg11David().setVisible(true);
        });
    }
